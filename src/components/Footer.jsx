...
const Footer = () => {
  return (
    <footer className="py-12 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 backdrop-blur-sm border-t border-cyan-500/20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Passionate MERN Stack Development | MongoDB • Express.js •
              React.js • Node.js | MySQL • RESTful APIs
            </p>
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#skills" className="text-gray-400 hover:text-cyan-400">
                  Skills
                </a>
              </li>
              <li>
          ...
          <div className="text-right">
            ...
            <a
              href="mailto:sc801377@gmail.com"
              className="text-gray-400 hover:text-cyan-400"
            >
              sc801377@gmail.com
            </a>
        ...
        <div className="text-center mt-12 pt-8 border-t border-cyan-500/20">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Subhajit Chakraborty. All rights
            reserved.
          </p>
        </div>
      </div>
